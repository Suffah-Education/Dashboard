    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-4">
          📚 Teacher: <span className="font-semibold text-gray-800">{batch.teacher?.name}</span>
        </p>
        {batch.description && (
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div className="bg-gray-50 p-4 rounded border border-gray-200">
                <p className="text-sm text-gray-600 font-semibold mb-2">Start Date</p>
                <p className="text-lg font-bold text-gray-800">
                  {batch.startDate ? new Date(batch.startDate).toLocaleDateString() : "TBA"}
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded border border-gray-200">
                <p className="text-sm text-gray-600 font-semibold mb-2">Batch Capacity</p>
                <p className="text-lg font-bold text-gray-800">
                  {batch.capacity ? `${batch.capacity} Students` : "Unlimited"}
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded border border-gray-200">
                <p className="text-sm text-gray-600 font-semibold mb-2">Total Classes</p>
                <p className="text-lg font-bold text-gray-800">
                  {batch.classes?.length || 0}
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded border border-gray-200">
                <p className="text-sm text-gray-600 font-semibold mb-2">Enrolled Students</p>
                <p className="text-lg font-bold text-gray-800">
